...
class Perceptron(Layer):
    ...
    def __init__(self, ci, cn, transf):
        ...
        if not hasattr(transf, 'out_minmax'):
            ...
            print("Modified np.asarray to np.asarray with dtype=float")  # Add this for debugging

            self.out_minmax = np.asarray([transf.out_minmax] * self.co, dtype=float)
...
class Reccurent(Layer):
    ...
    def __init__(self, ci, cn, transf, max_iter, delta):
        ...
        if not hasattr(transf, 'out_minmax'):
            ...
            self.out_minmax = np.asarray([transf.out_minmax] * self.co)
        self.initf = None
        self.s = np.zeros(self.cn)
